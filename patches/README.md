    ...
    "extra": {
        "patches": {
            ...
            "drupal/structure_sync": {
                "URL Alias of Taxonomy term is not exported": "https://www.drupal.org/files/issues/2024-04-11/structure_sync-3074288-export-import-taxonomy-terms-force-mode-18.patch"
            }
        }
    }
```
